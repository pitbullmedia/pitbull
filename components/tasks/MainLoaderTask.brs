...
sub GetContent()
    ...
    xfer.SetURL("http://168.149.194.222/meta-feed.json")
...
function GetItemData(video as Object) as Object
    ...
    if video.shortDescription <> invalid
        item.description1 = video.shortDescription
    else
        item.description1 = video.longDescription
    end if
